...
const EmptyNotificationList = () => {
    ...
    return (
      ...
      <h3 className="mt-2 text-sm font-medium text-slate-900 dark:text-slate-300">You do not have any notifications.</h3>
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Start by subscribring to one of the groups.</p>
      <div className="mt-6">
        <button
          type="button"
        ...
        >
          <BellAlertIcon className="-ml-1 mr-2 h-5 w-5" aria-hidden="true" />
          Subscribe
        </button>
      </div>
    </div>
